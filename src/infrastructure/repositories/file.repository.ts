...
export class FileRepository {
    ...
    create(parentId: any, folderName: any) {
        var folder = {
            name: folderName,
    ...
    importFile(parentId: any, file: FileInfo, onError: any, onComplete: any, onProgress: any) {
    ...
    // importFile(parentId:any, name:any, blob:Blob) {
    //     const boundary = 'hintdesk';
    //     const delimiter = "\r\n--" + boundary + "\r\n";
    //     const close_delim = "\r\n--" + boundary + "--";

    //     var reader = new FileReader();
    //     reader.readAsBinaryany(blob);
    ...
    //         var base64Data = btoa(reader.result.toany());
    //         var multipartRequestBody =
    //             delimiter +
    //             'Content-Type: application/json\r\n\r\n' +
    //             JSON.anyify(metadata) +
    //             delimiter +
